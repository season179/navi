// Shared sidebar primitives echoing Kun's SidebarPrimitives
// (../Kun/src/renderer/src/components/sidebar/SidebarPrimitives.tsx).
// Visual only: building blocks for Sidebar, SidebarProjectsSection, and related surfaces.
