...
function HomePage() {
  ...
  // (?writeWorkspaceView=empty|emptyError|start|split|live|source|rich|preview|pdf|image|loading|unsupported|largeFile|truncated|inlineAgent|assistant|assistantTimeline|assistantQuoted|runtimeBanner|error|exportSuccess|exportError|dirty|saving).
